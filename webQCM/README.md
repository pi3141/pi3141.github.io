...
Copier le dossier exemple (ex), le renommer et éditer le fichier questions.csv qui se trouvent à l'intérieur.

## Syntax du fichier questions.csv

La première ligne est le titre du questionnaire.

La deuxième ligne comprend les classes concernées (cela apparaîtra comme un choix dans la page d'identification)
...
Pour une question multiple: les réponses sont dans le champ r1, elles doivent être séparées par le caractère "|".
